...
class VideoData:
    ...
    _source_path: str = ""          # stored for regional-asynchrony re-read


def extract_video_data(video_path: str, max_frames: int = 300, roi: Optional[tuple] = None) -> Optional[VideoData]:
    """
    ...
    Parameters
    ----------
    roi : optional (x1, y1, x2, y2) tuple in pixel coordinates.
          If provided, only that region is analysed. If None, the full frame is used.
