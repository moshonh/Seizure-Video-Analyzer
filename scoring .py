...
def compute_scores(
    ...
    # When very_low_motion is flagged, rhythm_irregularity, amplitude_variability,
    # and temporal_evolution become unreliable (computed on near-zero signal noise).
    # Reduce their weights significantly to avoid false Evolving classification.
    eff_weights = Weights(
        ...
        amplitude_variability           = weights.amplitude_variability
                                          * (0.4 if video_data.quality_flags.get("very_low_motion") else 1.0),
        rhythm_irregularity             = weights.rhythm_irregularity
                                          * (0.4 if video_data.quality_flags.get("very_low_motion") else 1.0),
        temporal_evolution              = weights.temporal_evolution
                                          * (0.5 if video_data.quality_flags.get("very_low_motion") else 1.0),
