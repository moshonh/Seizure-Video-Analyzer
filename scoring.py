...
COMMIT_MARGIN              = 1.2    # minimum pnes-evol margin to commit
PNES_MIN_SCORE             = 4.5    # pnes_score must reach this to call PNES
EVOL_MIN_SCORE             = 4.0    # evol_score must reach this to call Evolving
PNES_MAX_EVOL              = 5.5    # evol must stay below this when calling PNES
EVOL_MAX_PNES              = 5.5    # pnes must stay below this when calling Evolving
...
class Weights:
    ...
    variance_drift:                  float = 1.5
    vector_change:                   float = 1.2
    amplitude_variability:           float = 1.2
    rhythm_irregularity:             float = 1.0
    temporal_evolution:              float = 2.5
