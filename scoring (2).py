...
class Weights:
    ...
    variance_drift: float = 3.5   # strongest discriminator — VD<0.4=PNES, VD>0.5=ES
    ...
    burst_recurrence: float = 2.5           # strong PNES indicator
    onset_offset_shape: float = 1.8
    burst_internal_consistency: float = 2.5  # strong PNES indicator
