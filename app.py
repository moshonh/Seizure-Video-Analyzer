...
| Movement direction | Repetitive / fixed | More changing |
| Rhythm / frequency | More constant | More variable |
| Temporal pattern | Burst–arrest–burst | Fade-in / fade-out |
...
motor PNES often appears more repetitive and less dynamically evolving over time,
while motor ES may show greater change in movement direction, rhythm, and temporal evolution.
...
""", unsafe_allow_html=True)
        ...
        nm5, nm6, nm7, nm8 = st.columns(4)
        nm5.metric("Stability Index",    f"{_f.stability_index:.2f}")
        nm6.metric("Rhythm Irregularity",f"{_f.rhythm_irregularity:.3f}",
                   help="CV of inter-peak intervals. High = irregular = ES.")
        nm7.metric("Temporal Evolution", f"{_f.temporal_evolution:.3f}",
                   help="Std of per-segment variability / overall variability. High = evolving = ES.")
        nm8.metric("Regional Asynchrony",f"{_f.regional_asynchrony:.4f}",
