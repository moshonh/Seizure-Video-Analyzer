...
|---------|-----------------|---------------|
| Distribution stability | Similar statistics over time | Statistics drift across windows |
...
while motor ES is more likely to show genuine change in direction, rhythm, amplitude, or distribution across the clip.
...
""", unsafe_allow_html=True)
        ...
        nm5, nm6, nm7, nm8, nm9 = st.columns(5)
        ...
        nm8.metric("Distribution Stability", f"{_f.temporal_distribution_stability:.3f}",
                   help="How similar the motion and variability distributions remain across windows. Higher = more stable over time = PNES.")
        nm9.metric("Regional Asynchrony",f"{_f.regional_asynchrony:.4f}",
